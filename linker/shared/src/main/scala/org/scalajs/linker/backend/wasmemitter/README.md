...
For example, a node `JSMethodApply(receiver, method, List(arg1, arg2))` is implemented as a call to helper that looks like:
...
Often, some of the inputs of these nodes are literals, or other trees that we can evaluated on the JS side.
