...
package object network {
  ...
  object IpAddress {
    final class Ipv4(val value: scala.scalajs.wit.Tuple4[scala.scalajs.wit.unsigned.UByte, scala.scalajs.wit.unsigned.UByte, scala.scalajs.wit.unsigned.UByte, scala.scalajs.wit.unsigned.UByte]) extends IpAddress {
    ...
    final class Ipv6(val value: scala.scalajs.wit.Tuple8[scala.scalajs.wit.unsigned.UShort, scala.scalajs.wit.unsigned.UShort, scala.scalajs.wit.unsigned.UShort, scala.scalajs.wit.unsigned.UShort, scala.scalajs.wit.unsigned.UShort, scala.scalajs.wit.unsigned.UShort, scala.scalajs.wit.unsigned.UShort, scala.scalajs.wit.unsigned.UShort]) extends IpAddress {
      override def equals(other: Any): Boolean = other match {
  ...
  final class Ipv4SocketAddress(val port: scala.scalajs.wit.unsigned.UShort, val address: scala.scalajs.wit.Tuple4[scala.scalajs.wit.unsigned.UByte, scala.scalajs.wit.unsigned.UByte, scala.scalajs.wit.unsigned.UByte, scala.scalajs.wit.unsigned.UByte]) {
    override def equals(other: Any): Boolean = other match {
  ...
  @scala.scalajs.wit.annotation.WitRecord
  final class Ipv6SocketAddress(val port: scala.scalajs.wit.unsigned.UShort, val flowInfo: scala.scalajs.wit.unsigned.UInt, val address: scala.scalajs.wit.Tuple8[scala.scalajs.wit.unsigned.UShort, scala.scalajs.wit.unsigned.UShort, scala.scalajs.wit.unsigned.UShort, scala.scalajs.wit.unsigned.UShort, scala.scalajs.wit.unsigned.UShort, scala.scalajs.wit.unsigned.UShort, scala.scalajs.wit.unsigned.UShort, scala.scalajs.wit.unsigned.UShort], val scopeId: scala.scalajs.wit.unsigned.UInt) {
    override def equals(other: Any): Boolean = other match {
