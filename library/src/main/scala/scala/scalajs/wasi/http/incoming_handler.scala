...
package object incoming_handler {

  // Type definitions
  type IncomingRequest = scala.scalajs.wasi.http.types.IncomingRequest

  type ResponseOutparam = scala.scalajs.wasi.http.types.ResponseOutparam
