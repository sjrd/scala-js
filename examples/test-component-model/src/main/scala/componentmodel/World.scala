...
trait World {
  ...
  def roundtripBasics1(a: cm.Tuple9[UByte, Byte, UShort, Short, UInt, Int, Float, Double, Char]):
      cm.Tuple9[UByte, Byte, UShort, Short, UInt, Int, Float, Double, Char]
  ...
  def roundtripTuple(a: cm.Tuple2[C1, Z1]): cm.Tuple2[C1, Z1]
  ...
  def roundtripResult(a: cm.Result[Unit, Unit]): cm.Result[Unit, Unit]

  @ComponentExport("component:testing/tests", "roundtrip-string-error")
  def roundtripStringError(a: cm.Result[Float, String]): cm.Result[Float, String]

  @ComponentExport("component:testing/tests", "roundtrip-enum-error")
  def roundtripEnumError(a: cm.Result[C1, E1]): cm.Result[C1, E1]
  ...
  def roundtripFlags(a: cm.Tuple2[F1, F1]): cm.Tuple2[F1, F1]

  @ComponentExport("component:testing/tests", "roundtrip-tuple2")
  def roundtripTuple2(a: cm.Tuple2[Int, String]): cm.Tuple2[Int, String]

  @ComponentExport("component:testing/tests", "roundtrip-tuple3")
  def roundtripTuple3(a: cm.Tuple3[Int, String, Boolean]): cm.Tuple3[Int, String, Boolean]
