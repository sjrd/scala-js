...
package object poll {
  ...
  trait Pollable {
     ...
     */
    @scala.scalajs.wit.annotation.WitResourceMethod("[method]pollable.ready")
    def methodPollableReady(self: Pollable): Boolean = scala.scalajs.wit.native
     ...
     */
    @scala.scalajs.wit.annotation.WitResourceMethod("[method]pollable.block")
    def methodPollableBlock(self: Pollable): Unit = scala.scalajs.wit.native
