...
class ArraysTest {
  ...
  def sortStringWithNullComparator(): Unit =
  ...
  def sortIsStable_Issue2400(): Unit = {
    case class N(i: Int)
  ...
  */
  ...
  def fillBooleanWithStartAndEndIndex(): Unit = {
    val booleans = new Array[Boolean](6)
  ...
  def fillByteWithStartAndEndIndex(): Unit = {
    val bytes = new Array[Byte](6)
  ...
  def fillShortWithStartAndEndIndex(): Unit = {
    val shorts = new Array[Short](6)
  ...
  def fillIntWithStartAndEndIndex(): Unit = {
    val ints = new Array[Int](6)
  ...
  def fillLongWithStartAndEndIndex(): Unit = {
    val longs = new Array[Long](6)
  ...
  def fillFloatWithStartAndEndIndex(): Unit = {
    val floats = new Array[Float](6)
  ...
  def fillDoubleWithStartAndEndIndex(): Unit = {
    val doubles = new Array[Double](6)
  ...
  def fillAnyRefWithStartAndEndIndex(): Unit = {
  ...
  def binarySearchWithStartAndEndIndexOnLong(): Unit = {
  ...
  def binarySearchWithStartAndEndIndexOnInt(): Unit = {
  ...
  def binarySearchWithStartAndEndIndexOnShort(): Unit = {
  ...
  def binarySearchWithStartAndEndIndexOnChar(): Unit = {
  ...
  def binarySearchWithStartAndEndIndexOnDouble(): Unit = {
  ...
  def binarySearchWithStartAndEndIndexOnFloat(): Unit = {
  ...
  def binarySearchWithStartAndEndIndexOnAnyRef(): Unit = {
  ...
  def binarySearchWithStartAndEndIndexOnSpecificAnyRefWithNullComparator(): Unit = {
  ...
  def binarySearchOnSpecificAnyRefWithNullComparator(): Unit = {
    val strings: Array[String] = Array("aac", "abc", "cc", "cf", "zz", "zzzs", "zzzt")
  ...
  def binarySearchWithStartAndEndIndexOnSpecificAnyRefWithComparator(): Unit = {
  ...
  def binarySearchOnSpecificAnyRefWithComparator(): Unit = {
    val cmp = new java.util.Comparator[(Int, Int)] {
      def compare(o1: (Int, Int), o2: (Int, Int)): Int =
        if (o1._1 != o2._1) Integer.compare(o1._1, o2._1)
        else Integer.compare(o1._2, o2._2)
  ...
  def copyOfAnyRefWithChangeOfType(): Unit = {
    class A
  ...
  def copyOfRangeAnyRefWithChangeOfType(): Unit = {
    class A
    case class B(x: Int) extends A
