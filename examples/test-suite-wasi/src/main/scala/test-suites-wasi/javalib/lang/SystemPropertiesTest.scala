...
class SystemPropertiesTest {
  ...
  private def resetSystemPropertiesAfterEachTest(): Unit = {
   ...
   */
  def testScenariosWithoutJavaUtilProperties(): Unit = {
    ...
    resetSystemPropertiesAfterEachTest()
  }
   ...
   */
  def testScenariosWithGetProperties(): Unit = {
   ...
   */
  def testScenariosWithSetProperties(): Unit = {
