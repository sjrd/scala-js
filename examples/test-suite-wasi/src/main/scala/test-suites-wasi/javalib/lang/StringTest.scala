...
class StringTest {
  ...
  // TODO: Exception
  /*
  def charAtIndexOutOfBounds(): Unit = {
  ...
  def codePointAtIndexOutOfBounds(): Unit = {
    assumeTrue("Assuming compliant StringIndexOutOfBounds",
        hasCompliantStringIndexOutOfBounds)
  ...
  */
  ...
  def codePointBeforeIndexOutOfBounds(): Unit = {
    // assumeTrue("Assuming compliant StringIndexOutOfBounds",
    //     hasCompliantStringIndexOutOfBounds)
  ...
  def substringBeginIndexOutOfBounds(): Unit = {
    // assumeTrue("Assuming compliant StringIndexOutOfBounds",
    //     hasCompliantStringIndexOutOfBounds)
  ...
  def substringBeginEndIndexOutOfBounds(): Unit = {
    // assumeTrue("Assuming compliant StringIndexOutOfBounds",
    //     hasCompliantStringIndexOutOfBounds)
  ...
  def subSequenceIndexOutOfBounds(): Unit = {
    // assumeTrue("Assuming compliant StringIndexOutOfBounds",
    //     hasCompliantStringIndexOutOfBounds)
  ...
  def splitWithCharAsArgument(): Unit = {
  ...
  def createFromLargeCharArray_Issue2553(): Unit = {
    val largeCharArray =
  ...
  def createFromLargeCodePointArray_Issue2553(): Unit = {
  ...
  def stringCaseInsensitiveOrdering(): Unit = {
