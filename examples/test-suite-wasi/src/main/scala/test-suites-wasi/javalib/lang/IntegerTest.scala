...
class IntegerTest {
  ...
  def parseUnsignedIntInvalidThrows(): Unit = {
    def test(s: String, radix: Int = 10): Unit = {
  ...
  def decodeStringInvalidThrows(): Unit = {
  ...
  def parseUnsignedIntRadix(): Unit = {
    def test(s: String, v: Int, radix: Int = 10): Unit = {
      assertEquals(v, Integer.parseUnsignedInt(s, radix))
    }
  ...
  def parseUnsignedIntRadixInvalidThrows(): Unit = {
    def test(s: String, radix: Int = 10): Unit =
  ...
  def parseUnsignedIntBase16(): Unit = {
    def test(s: String, v: Int): Unit = {
  ...
  def toUnsignedStringRadix(): Unit = {
