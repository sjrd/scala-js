...
class StringBuilderTest {
  ...
  def appendCharSequenceStartEnd(): Unit = {
  ...
  def appendCharArrayOffsetLen(): Unit = {
  ...
  def insertCharArrayOffsetLen(): Unit = {
  ...
  def insertCharSequenceStartEnd(): Unit = {
  ...
  def offsetByCodePointsBackwards(): Unit = {
    val sb = initBuilder(
        "abc\uD834\uDF06de\uD834\uDF06fgh\uD834ij\uDF06\uD834kl\uDF06")
  ...
  def stringInterpolationToSurviveNullAndUndefined(): Unit = {
