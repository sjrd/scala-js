...
class CharacterTest {
  ...
  def isSupplementaryCodePoint(): Unit = {
  ...
  def codePointAtCharSequence(): Unit = {
  ...
  def codePointAtCharSequenceIndexOutOfBounds(): Unit = {
  ...
  def codePointAtArrayIndexOutOfBounds(): Unit = {
  ...
  def codePointAtArrayWithLimit(): Unit = {
  ...
  def codePointAtArrayWithLimitIndexOutOfBounds(): Unit = {
  ...
  def codePointBeforeCharSequence(): Unit = {
  ...
  def codePointBeforeCharSequenceIndexOutOfBounds(): Unit = {
    // assumeTrue("Assuming compliant StringIndexOutOfBounds",
    //     hasCompliantStringIndexOutOfBounds)
  ...
  def codePointBeforeArrayIndexOutOfBounds(): Unit = {
    // assumeTrue("Assuming compliant ArrayIndexOutOfBounds",
    //     hasCompliantArrayIndexOutOfBounds)
  ...
  def codePointBeforeArrayWithStart(): Unit = {
  ...
  def codePointBeforeArrayWithStartIndexOutOfBounds(): Unit = {
    assertThrows(classOf[IndexOutOfBoundsException],
  ...
  def offsetByCodePointsCharSequence(): Unit = {
  ...
  def offsetByCodePointsCharSequenceBackwards(): Unit = {
    val s: CharSequence = "abc\ud834\udf06de\ud834\udf06fgh\ud834ij\udf06\ud834kl\udf06"
  ...
  def offsetByCodePointsArray(): Unit = {
    val a: Array[Char] =
  ...
  def offsetByCodePointsArrayBackwards(): Unit = {
    val a: Array[Char] =
      "abc\ud834\udf06de\ud834\udf06fgh\ud834ij\udf06\ud834kl\udf06".toCharArray()
    val len = a.length
  ...
  def toLowerCaseCompareCharAndCodepoint(): Unit = {
   ...
   * test.
   */
  def toLowerCaseCodePointSpecialCases(): Unit = {
...
for (cp <- 0 to Character.MAX_CODE_POINT) {
  ...
  */
  def toLowerCaseCodePointStringLowerCaseDiffCharacterLowerCase(): Unit = {
    assertEquals(0x0069, Character.toLowerCase(0x0130)) // İ => i
  }

  def toUpperCaseCompareCharAndCodepoint(): Unit = {
    for (ch <- Character.MIN_VALUE to Character.MAX_VALUE)
      assertEquals(Character.toUpperCase(ch), Character.toUpperCase(ch.toInt).toChar)
  }

  def toUpperCaseInt(): Unit = {
    // ASCII, not a letter
   ...
   */
  def toUpperCaseCodePointSpecialCases(): Unit = {
...
for (cp <- 0 to Character.MAX_CODE_POINT) {
  ...
  */
  def toUpperCaseCodePointStringUpperCaseDiffCharacterUpperCase(): Unit = {
  ...
  def toTitleCaseCompareCharAndCodepoint(): Unit = {
    for (ch <- Character.MIN_VALUE to Character.MAX_VALUE)
      assertEquals(Character.toTitleCase(ch), Character.toTitleCase(ch.toInt).toChar)
  }

  def toTitleCaseCodePointSpecialCases(): Unit = {
...
*/
  def toTitleCaseCodePointStringUpperCaseDiffCharacterTitleCase(): Unit = {
  ...
  def codePointCountCharSequence(): Unit = {
