...
class ThrowablesTest {
  ...
  def allJavaLangErrorsAndExceptions(): Unit = {
  ...
  def throwableMessage_Issue2559(): Unit = {
  ...
  def throwableStillHasMethodsOfObject(): Unit = {
    @noinline
  ...
  def throwableJSToStringCanBeOverridden(): Unit = {
  ...
  def assertionErrorsPeculiarConstructors(): Unit = {
