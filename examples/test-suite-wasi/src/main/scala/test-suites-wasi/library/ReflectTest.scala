...
class ReflectTest {
  ...
  private final val Prefix = "testSuiteWASI.library.ReflectTest$"
  ...
  private final val NameInnerObject = {
   ...
   def testClassRuntimeClass(): Unit = {
    for {
   ...
   def testObjectRuntimeClass(): Unit = {
    for {
   ...
   def testClassCannotBeFound(): Unit = {
    for {
   ...
   def testObjectCannotBeFound(): Unit = {
    for {
      name <- Seq(NameClassEnableDirect, NameClassEnableDirectNoZeroArgCtor,
   ...
   def testClassNoArgCtorErrorCase(): Unit = {
   ...
   def testClassCtorWithArgs(): Unit = {
   ...
   def testInnerObjectWithEnableReflectiveInstantiation_Issue3228(): Unit = {
   ...
   def testLocalClassWithReflectiveInstantiationInLambda_Issue3227(): Unit = {
