...
class OuterClassTest {
  ...
  def `Test code variant 1 from #2382`(): Unit = {
    val b1 = new B1 {}
    val y1 = new b1.Y1
    val z1 = new y1.Z1
  ...
  def `Test code variant 2 from #2382`(): Unit = {
    val b2 = new B2 {}
    val y2 = new b2.Y2
    val z2 = new y2.Z2
  ...
  def `Test code variant 3 from #2382`(): Unit = {
    val a3 = new A3 {}
    val y3 = new a3.Y3
    val z3 = new y3.Z3
  ...
  def `Test code variant 4 from #2382`(): Unit = {
    val a4 = new A4 {}
    val y4 = new a4.Y4
    val z4 = new y4.Z4
  ...
  def `Test code variant 5 from #2382`(): Unit = {
    val a5 = new A5 {}
    val y5 = new a5.Y5
    val z5 = new y5.Z5
