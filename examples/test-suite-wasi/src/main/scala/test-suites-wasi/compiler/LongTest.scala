...
class LongTest {
  ...
  // Tests
   ...
   def sanityOfEqualityTests(): Unit = {
   ...
   def hashHashInCaseClasses(): Unit = {
   ...
   def compareOtherNumericTypes(): Unit = {
    assertTrue(5L == 5)
    assertTrue(5 == 5L)
    assertTrue(4 != 5L)
    assertTrue('A' == 65L)
...
object LongTest {
  ...
  val usesClosureCompiler = false
  val scalaVersion = "2.12.19" // random
