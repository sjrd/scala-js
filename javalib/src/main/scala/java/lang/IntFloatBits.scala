...
sealed abstract class IntFloatBits[I, F] {
  ...
  def newFloatBox(x: F): Box[FloatType]
...
object IntFloatBits {
  ...
  @inline
  final class Int32Box(var value: scala.Int) extends Box[scala.Int]

  @inline
  final class Float32Box(var value: scala.Float) extends Box[scala.Float]

  @inline
  final class Int64Box(var value: scala.Long) extends Box[scala.Long]

  @inline
  final class Float64Box(var value: scala.Double) extends Box[scala.Double]

  @inline
  final class IntOps[I, F](private val x: I)(implicit ops: IntFloatBits[I, F]) {
    @inline def unary_- : I = ops.sub(ops.zero, x)
    @inline def unary_~ : I = ops.xor(ops.minusOne, x)
  ...
  final class FloatOps[I, F](private val x: F)(implicit ops: IntFloatBits[I, F]) {
    @inline def unary_- : F = ops.fsub(ops.fzero, x)
  ...
  implicit object Bits32 extends IntFloatBits[Int, scala.Float] {
    ...
    @inline def newFloatBox(x: FloatType): Box[FloatType] = new Float32Box(x)
    ...
    @inline def toFloat32Round(x: FloatType): scala.Float = x
    ...
    @inline def floatToInt(x: FloatType): IntType = x.toInt
  ...
  implicit object Bits64 extends IntFloatBits[scala.Long, scala.Double] {
    ...
    @inline def newFloatBox(x: FloatType): Box[FloatType] = new Float64Box(x)
    ...
    @inline def toFloat32Round(x: FloatType): scala.Float = x.toFloat
    ...
    @inline def floatToInt(x: FloatType): IntType = x.toLong
