...
def Tasks = [
  ...
  "test-suite-webassembly": '''
    ...
    sbtretry ++$scala \
        ...
        'set scalaJSLinkerConfig in helloworld.v$v ~= (_.withESFeatures(_.withESVersion(ESVersion.$esVersion)).withWasmFeatures(_.withUseJSPI($jspi).withUseCustomDescriptors($customDescriptors)))' \
        helloworld$v/run &&
    sbtretry ++$scala \
        'set Global/enableWasmEverywhere := true' \
        'set scalaJSLinkerConfig in helloworld.v$v ~= (_.withESFeatures(_.withESVersion(ESVersion.$esVersion)).withWasmFeatures(_.withUseJSPI($jspi).withUseCustomDescriptors($customDescriptors)))' \
    ...
    sbtretry ++$scala \
        'set Global/enableWasmEverywhere := true' \
        'set scalaJSLinkerConfig in reversi.v$v ~= (_.withESFeatures(_.withESVersion(ESVersion.$esVersion)).withWasmFeatures(_.withUseJSPI($jspi).withUseCustomDescriptors($customDescriptors)))' \
        reversi$v/fastLinkJS \
        reversi$v/fullLinkJS &&
    sbtretry ++$scala \
        'set Global/enableWasmEverywhere := true' \
        'set scalaJSLinkerConfig in jUnitTestOutputsJS.v$v ~= (_.withESFeatures(_.withESVersion(ESVersion.$esVersion)).withWasmFeatures(_.withUseJSPI($jspi).withUseCustomDescriptors($customDescriptors)))' \
        'set scalaJSLinkerConfig in testBridge.v$v ~= (_.withESFeatures(_.withESVersion(ESVersion.$esVersion)).withWasmFeatures(_.withUseJSPI($jspi).withUseCustomDescriptors($customDescriptors)))' \
        jUnitTestOutputsJS$v/test testBridge$v/test \
        'set scalaJSStage in Global := FullOptStage' \
        jUnitTestOutputsJS$v/test testBridge$v/test &&
    sbtretry ++$scala \
        'set Global/enableWasmEverywhere := true' \
        'set scalaJSLinkerConfig in $testSuite.v$v ~= (_.withESFeatures(_.withESVersion(ESVersion.$esVersion)).withWasmFeatures(_.withUseJSPI($jspi).withUseCustomDescriptors($customDescriptors)))' \
        $testSuite$v/test &&
    sbtretry ++$scala \
        'set Global/enableWasmEverywhere := true' \
        'set scalaJSLinkerConfig in $testSuite.v$v ~= (_.withESFeatures(_.withESVersion(ESVersion.$esVersion)).withWasmFeatures(_.withUseJSPI($jspi).withUseCustomDescriptors($customDescriptors)))' \
...
mainScalaVersions.each { scalaVersion ->
  ...
  quickMatrix.add([task: "test-suite-webassembly", scala: scalaVersion, java: mainJavaVersion, esVersion: minWasmESVersion, jspi: "false", customDescriptors: "false", testMinify: "false", testSuite: "testSuite"])
  quickMatrix.add([task: "test-suite-webassembly", scala: scalaVersion, java: mainJavaVersion, esVersion: minWasmESVersion, jspi: "true", customDescriptors: "true", testMinify: "false", testSuite: "testSuite"])
  quickMatrix.add([task: "test-suite-webassembly", scala: scalaVersion, java: mainJavaVersion, esVersion: minWasmESVersion, jspi: "true", customDescriptors: "true", testMinify: "false", testSuite: "testSuite"])
